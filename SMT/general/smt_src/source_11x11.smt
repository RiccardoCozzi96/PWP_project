...
(define-fun max_width () Int 11)
(define-fun max_height () Int 11)
...
(define-fun p5_w_default () Int 5)
(define-fun p5_h_default () Int 3)
(define-fun p6_w_default () Int 5)
(define-fun p6_h_default () Int 4)
(define-fun p7_w_default () Int 8)
(define-fun p7_h_default () Int 4)
