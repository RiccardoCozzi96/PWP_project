...
(define-fun max_width () Int 15)
(define-fun max_height () Int 15)
...
(define-fun p8_h_default () Int 12)
(define-fun p9_w_default () Int 3)
(define-fun p9_h_default () Int 15)
(define-fun p10_w_default () Int 6)
(define-fun p10_h_default () Int 3)
