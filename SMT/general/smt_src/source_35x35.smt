...
(define-fun max_width () Int 35)
(define-fun max_height () Int 35)
...
(define-fun p10_h_default () Int 19)
(define-fun p11_w_default () Int 3)
(define-fun p11_h_default () Int 22)
(define-fun p12_w_default () Int 4)
(define-fun p12_h_default () Int 3)
(define-fun p13_w_default () Int 4)
(define-fun p13_h_default () Int 4)
(define-fun p14_w_default () Int 4)
(define-fun p14_h_default () Int 5)
(define-fun p15_w_default () Int 4)
(define-fun p15_h_default () Int 6)
(define-fun p16_w_default () Int 4)
(define-fun p16_h_default () Int 7)
...
(define-fun p19_h_default () Int 17)
(define-fun p20_w_default () Int 4)
(define-fun p20_h_default () Int 20)
(define-fun p21_w_default () Int 4)
(define-fun p21_h_default () Int 23)
(define-fun p22_w_default () Int 14)
(define-fun p22_h_default () Int 35)
