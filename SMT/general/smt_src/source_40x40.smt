...
(define-fun max_width () Int 40)
(define-fun max_height () Int 40)
...
(define-fun p17_w_default () Int 5)
(define-fun p17_h_default () Int 8)
(define-fun p18_w_default () Int 5)
(define-fun p18_h_default () Int 12)
(define-fun p19_w_default () Int 5)
(define-fun p19_h_default () Int 13)
(define-fun p20_w_default () Int 22)
(define-fun p20_h_default () Int 40)
