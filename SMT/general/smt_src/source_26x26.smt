...
(define-fun p14_h_default () Int 17)
(define-fun p15_w_default () Int 3)
(define-fun p15_h_default () Int 19)
...
(define-fun p19_h_default () Int 7)
(define-fun p20_w_default () Int 4)
(define-fun p20_h_default () Int 8)
(define-fun p21_w_default () Int 4)
(define-fun p21_h_default () Int 11)
(define-fun p22_w_default () Int 4)
(define-fun p22_h_default () Int 14)
