...
(define-fun max_width () Int 31)
(define-fun max_height () Int 31)
...
(define-fun p13_h_default () Int 22)
(define-fun p14_w_default () Int 3)
(define-fun p14_h_default () Int 31)
...
(define-fun p19_w_default () Int 12)
(define-fun p19_h_default () Int 31)
