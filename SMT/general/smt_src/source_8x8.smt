...
(define-fun max_width () Int 8)
(define-fun max_height () Int 8)
...
(define-fun p2_h_default () Int 5)
(define-fun p3_w_default () Int 5)
(define-fun p3_h_default () Int 3)
(define-fun p4_w_default () Int 5)
(define-fun p4_h_default () Int 5)
