...
(define-fun max_width () Int 36)
(define-fun max_height () Int 36)
...
(define-fun p12_h_default () Int 15)
(define-fun p13_w_default () Int 3)
(define-fun p13_h_default () Int 16)
(define-fun p14_w_default () Int 3)
(define-fun p14_h_default () Int 24)
(define-fun p15_w_default () Int 3)
(define-fun p15_h_default () Int 36)
(define-fun p16_w_default () Int 4)
(define-fun p16_h_default () Int 3)
(define-fun p17_w_default () Int 4)
(define-fun p17_h_default () Int 11)
(define-fun p18_w_default () Int 4)
(define-fun p18_h_default () Int 22)
(define-fun p19_w_default () Int 5)
(define-fun p19_h_default () Int 3)
(define-fun p20_w_default () Int 5)
(define-fun p20_h_default () Int 4)
(define-fun p21_w_default () Int 5)
(define-fun p21_h_default () Int 14)
(define-fun p22_w_default () Int 5)
(define-fun p22_h_default () Int 15)
(define-fun p23_w_default () Int 12)
(define-fun p23_h_default () Int 36)
