...
(define-fun max_width () Int 10)
(define-fun max_height () Int 10)
...
(define-fun p3_h_default () Int 6)
(define-fun p4_w_default () Int 3)
(define-fun p4_h_default () Int 7)
(define-fun p5_w_default () Int 4)
(define-fun p5_h_default () Int 4)
(define-fun p6_w_default () Int 4)
(define-fun p6_h_default () Int 6)
