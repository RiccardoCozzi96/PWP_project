...
(define-fun max_width () Int 34)
(define-fun max_height () Int 34)
...
(define-fun p13_h_default () Int 21)
(define-fun p14_w_default () Int 3)
(define-fun p14_h_default () Int 22)
(define-fun p15_w_default () Int 3)
(define-fun p15_h_default () Int 25)
(define-fun p16_w_default () Int 3)
(define-fun p16_h_default () Int 34)
(define-fun p17_w_default () Int 4)
(define-fun p17_h_default () Int 4)
(define-fun p18_w_default () Int 4)
(define-fun p18_h_default () Int 5)
(define-fun p19_w_default () Int 4)
(define-fun p19_h_default () Int 11)
(define-fun p20_w_default () Int 4)
(define-fun p20_h_default () Int 14)
(define-fun p21_w_default () Int 12)
(define-fun p21_h_default () Int 34)
