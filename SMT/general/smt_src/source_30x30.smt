...
(define-fun max_width () Int 30)
(define-fun max_height () Int 30)
...
(define-fun p12_h_default () Int 16)
(define-fun p13_w_default () Int 3)
(define-fun p13_h_default () Int 19)
(define-fun p14_w_default () Int 3)
(define-fun p14_h_default () Int 25)
...
(define-fun p17_h_default () Int 6)
(define-fun p18_w_default () Int 4)
(define-fun p18_h_default () Int 8)
(define-fun p19_w_default () Int 4)
(define-fun p19_h_default () Int 9)
(define-fun p20_w_default () Int 11)
(define-fun p20_h_default () Int 30)
