...
(define-fun max_width () Int 39)
(define-fun max_height () Int 39)
...
(define-fun p12_h_default () Int 4)
(define-fun p13_w_default () Int 4)
(define-fun p13_h_default () Int 5)
(define-fun p14_w_default () Int 4)
(define-fun p14_h_default () Int 6)
(define-fun p15_w_default () Int 4)
(define-fun p15_h_default () Int 8)
(define-fun p16_w_default () Int 4)
(define-fun p16_h_default () Int 9)
(define-fun p17_w_default () Int 4)
(define-fun p17_h_default () Int 12)
(define-fun p18_w_default () Int 4)
(define-fun p18_h_default () Int 15)
(define-fun p19_w_default () Int 4)
(define-fun p19_h_default () Int 16)
(define-fun p20_w_default () Int 5)
(define-fun p20_h_default () Int 3)
(define-fun p21_w_default () Int 5)
(define-fun p21_h_default () Int 4)
(define-fun p22_w_default () Int 5)
(define-fun p22_h_default () Int 5)
(define-fun p23_w_default () Int 5)
(define-fun p23_h_default () Int 6)
(define-fun p24_w_default () Int 5)
(define-fun p24_h_default () Int 8)
(define-fun p25_w_default () Int 5)
(define-fun p25_h_default () Int 10)
(define-fun p26_w_default () Int 5)
(define-fun p26_h_default () Int 11)
(define-fun p27_w_default () Int 5)
(define-fun p27_h_default () Int 13)
(define-fun p28_w_default () Int 5)
(define-fun p28_h_default () Int 18)
(define-fun p29_w_default () Int 15)
(define-fun p29_h_default () Int 39)
...
(declare-const p25_w Int)
(declare-const p25_h Int)
(declare-const p26_w Int)
(declare-const p26_h Int)
(declare-const p27_w Int)
(declare-const p27_h Int)
(declare-const p28_w Int)
(declare-const p28_h Int)
(declare-const p29_w Int)
(declare-const p29_h Int)
...
(assert (or (and (= p25_w p25_w_default) (= p25_h p25_h_default))                                         (and (= p25_w p25_h_default) (= p25_h p25_w_default)) ))

(assert (or (and (= p26_w p26_w_default) (= p26_h p26_h_default))                                         (and (= p26_w p26_h_default) (= p26_h p26_w_default)) ))

(assert (or (and (= p27_w p27_w_default) (= p27_h p27_h_default))                                         (and (= p27_w p27_h_default) (= p27_h p27_w_default)) ))

(assert (or (and (= p28_w p28_w_default) (= p28_h p28_h_default))                                         (and (= p28_w p28_h_default) (= p28_h p28_w_default)) ))

(assert (or (and (= p29_w p29_w_default) (= p29_h p29_h_default))                                         (and (= p29_w p29_h_default) (= p29_h p29_w_default)) ))
...
(declare-const p25_x Int)
(declare-const p25_y Int)
(declare-const p26_x Int)
(declare-const p26_y Int)
(declare-const p27_x Int)
(declare-const p27_y Int)
(declare-const p28_x Int)
(declare-const p28_y Int)
(declare-const p29_x Int)
(declare-const p29_y Int)
...
(assert (not (exceeds p25_x p25_y p25_w p25_h))) ;p25 coordinates do not exceed the sheet dimensions
(assert (not (exceeds p26_x p26_y p26_w p26_h))) ;p26 coordinates do not exceed the sheet dimensions
(assert (not (exceeds p27_x p27_y p27_w p27_h))) ;p27 coordinates do not exceed the sheet dimensions
(assert (not (exceeds p28_x p28_y p28_w p28_h))) ;p28 coordinates do not exceed the sheet dimensions
(assert (not (exceeds p29_x p29_y p29_w p29_h))) ;p29 coordinates do not exceed the sheet dimensions
...
(assert (not (overlap p25_x p25_y p25_w p25_h p1_x p1_y p1_w p1_h))) 	;p25 with p1
(assert (not (overlap p1_x p1_y p1_w p1_h p25_x p25_y p25_w p25_h))) 	;p1 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p1_x p1_y p1_w p1_h))) 	;p26 with p1
(assert (not (overlap p1_x p1_y p1_w p1_h p26_x p26_y p26_w p26_h))) 	;p1 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p1_x p1_y p1_w p1_h))) 	;p27 with p1
(assert (not (overlap p1_x p1_y p1_w p1_h p27_x p27_y p27_w p27_h))) 	;p1 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p1_x p1_y p1_w p1_h))) 	;p28 with p1
(assert (not (overlap p1_x p1_y p1_w p1_h p28_x p28_y p28_w p28_h))) 	;p1 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p1_x p1_y p1_w p1_h))) 	;p29 with p1
(assert (not (overlap p1_x p1_y p1_w p1_h p29_x p29_y p29_w p29_h))) 	;p1 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p2_x p2_y p2_w p2_h))) 	;p25 with p2
(assert (not (overlap p2_x p2_y p2_w p2_h p25_x p25_y p25_w p25_h))) 	;p2 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p2_x p2_y p2_w p2_h))) 	;p26 with p2
(assert (not (overlap p2_x p2_y p2_w p2_h p26_x p26_y p26_w p26_h))) 	;p2 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p2_x p2_y p2_w p2_h))) 	;p27 with p2
(assert (not (overlap p2_x p2_y p2_w p2_h p27_x p27_y p27_w p27_h))) 	;p2 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p2_x p2_y p2_w p2_h))) 	;p28 with p2
(assert (not (overlap p2_x p2_y p2_w p2_h p28_x p28_y p28_w p28_h))) 	;p2 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p2_x p2_y p2_w p2_h))) 	;p29 with p2
(assert (not (overlap p2_x p2_y p2_w p2_h p29_x p29_y p29_w p29_h))) 	;p2 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p3_x p3_y p3_w p3_h))) 	;p25 with p3
(assert (not (overlap p3_x p3_y p3_w p3_h p25_x p25_y p25_w p25_h))) 	;p3 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p3_x p3_y p3_w p3_h))) 	;p26 with p3
(assert (not (overlap p3_x p3_y p3_w p3_h p26_x p26_y p26_w p26_h))) 	;p3 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p3_x p3_y p3_w p3_h))) 	;p27 with p3
(assert (not (overlap p3_x p3_y p3_w p3_h p27_x p27_y p27_w p27_h))) 	;p3 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p3_x p3_y p3_w p3_h))) 	;p28 with p3
(assert (not (overlap p3_x p3_y p3_w p3_h p28_x p28_y p28_w p28_h))) 	;p3 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p3_x p3_y p3_w p3_h))) 	;p29 with p3
(assert (not (overlap p3_x p3_y p3_w p3_h p29_x p29_y p29_w p29_h))) 	;p3 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p4_x p4_y p4_w p4_h))) 	;p25 with p4
(assert (not (overlap p4_x p4_y p4_w p4_h p25_x p25_y p25_w p25_h))) 	;p4 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p4_x p4_y p4_w p4_h))) 	;p26 with p4
(assert (not (overlap p4_x p4_y p4_w p4_h p26_x p26_y p26_w p26_h))) 	;p4 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p4_x p4_y p4_w p4_h))) 	;p27 with p4
(assert (not (overlap p4_x p4_y p4_w p4_h p27_x p27_y p27_w p27_h))) 	;p4 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p4_x p4_y p4_w p4_h))) 	;p28 with p4
(assert (not (overlap p4_x p4_y p4_w p4_h p28_x p28_y p28_w p28_h))) 	;p4 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p4_x p4_y p4_w p4_h))) 	;p29 with p4
(assert (not (overlap p4_x p4_y p4_w p4_h p29_x p29_y p29_w p29_h))) 	;p4 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p5_x p5_y p5_w p5_h))) 	;p25 with p5
(assert (not (overlap p5_x p5_y p5_w p5_h p25_x p25_y p25_w p25_h))) 	;p5 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p5_x p5_y p5_w p5_h))) 	;p26 with p5
(assert (not (overlap p5_x p5_y p5_w p5_h p26_x p26_y p26_w p26_h))) 	;p5 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p5_x p5_y p5_w p5_h))) 	;p27 with p5
(assert (not (overlap p5_x p5_y p5_w p5_h p27_x p27_y p27_w p27_h))) 	;p5 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p5_x p5_y p5_w p5_h))) 	;p28 with p5
(assert (not (overlap p5_x p5_y p5_w p5_h p28_x p28_y p28_w p28_h))) 	;p5 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p5_x p5_y p5_w p5_h))) 	;p29 with p5
(assert (not (overlap p5_x p5_y p5_w p5_h p29_x p29_y p29_w p29_h))) 	;p5 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p6_x p6_y p6_w p6_h))) 	;p25 with p6
(assert (not (overlap p6_x p6_y p6_w p6_h p25_x p25_y p25_w p25_h))) 	;p6 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p6_x p6_y p6_w p6_h))) 	;p26 with p6
(assert (not (overlap p6_x p6_y p6_w p6_h p26_x p26_y p26_w p26_h))) 	;p6 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p6_x p6_y p6_w p6_h))) 	;p27 with p6
(assert (not (overlap p6_x p6_y p6_w p6_h p27_x p27_y p27_w p27_h))) 	;p6 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p6_x p6_y p6_w p6_h))) 	;p28 with p6
(assert (not (overlap p6_x p6_y p6_w p6_h p28_x p28_y p28_w p28_h))) 	;p6 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p6_x p6_y p6_w p6_h))) 	;p29 with p6
(assert (not (overlap p6_x p6_y p6_w p6_h p29_x p29_y p29_w p29_h))) 	;p6 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p7_x p7_y p7_w p7_h))) 	;p25 with p7
(assert (not (overlap p7_x p7_y p7_w p7_h p25_x p25_y p25_w p25_h))) 	;p7 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p7_x p7_y p7_w p7_h))) 	;p26 with p7
(assert (not (overlap p7_x p7_y p7_w p7_h p26_x p26_y p26_w p26_h))) 	;p7 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p7_x p7_y p7_w p7_h))) 	;p27 with p7
(assert (not (overlap p7_x p7_y p7_w p7_h p27_x p27_y p27_w p27_h))) 	;p7 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p7_x p7_y p7_w p7_h))) 	;p28 with p7
(assert (not (overlap p7_x p7_y p7_w p7_h p28_x p28_y p28_w p28_h))) 	;p7 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p7_x p7_y p7_w p7_h))) 	;p29 with p7
(assert (not (overlap p7_x p7_y p7_w p7_h p29_x p29_y p29_w p29_h))) 	;p7 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p8_x p8_y p8_w p8_h))) 	;p25 with p8
(assert (not (overlap p8_x p8_y p8_w p8_h p25_x p25_y p25_w p25_h))) 	;p8 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p8_x p8_y p8_w p8_h))) 	;p26 with p8
(assert (not (overlap p8_x p8_y p8_w p8_h p26_x p26_y p26_w p26_h))) 	;p8 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p8_x p8_y p8_w p8_h))) 	;p27 with p8
(assert (not (overlap p8_x p8_y p8_w p8_h p27_x p27_y p27_w p27_h))) 	;p8 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p8_x p8_y p8_w p8_h))) 	;p28 with p8
(assert (not (overlap p8_x p8_y p8_w p8_h p28_x p28_y p28_w p28_h))) 	;p8 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p8_x p8_y p8_w p8_h))) 	;p29 with p8
(assert (not (overlap p8_x p8_y p8_w p8_h p29_x p29_y p29_w p29_h))) 	;p8 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p9_x p9_y p9_w p9_h))) 	;p25 with p9
(assert (not (overlap p9_x p9_y p9_w p9_h p25_x p25_y p25_w p25_h))) 	;p9 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p9_x p9_y p9_w p9_h))) 	;p26 with p9
(assert (not (overlap p9_x p9_y p9_w p9_h p26_x p26_y p26_w p26_h))) 	;p9 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p9_x p9_y p9_w p9_h))) 	;p27 with p9
(assert (not (overlap p9_x p9_y p9_w p9_h p27_x p27_y p27_w p27_h))) 	;p9 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p9_x p9_y p9_w p9_h))) 	;p28 with p9
(assert (not (overlap p9_x p9_y p9_w p9_h p28_x p28_y p28_w p28_h))) 	;p9 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p9_x p9_y p9_w p9_h))) 	;p29 with p9
(assert (not (overlap p9_x p9_y p9_w p9_h p29_x p29_y p29_w p29_h))) 	;p9 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p10_x p10_y p10_w p10_h))) 	;p25 with p10
(assert (not (overlap p10_x p10_y p10_w p10_h p25_x p25_y p25_w p25_h))) 	;p10 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p10_x p10_y p10_w p10_h))) 	;p26 with p10
(assert (not (overlap p10_x p10_y p10_w p10_h p26_x p26_y p26_w p26_h))) 	;p10 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p10_x p10_y p10_w p10_h))) 	;p27 with p10
(assert (not (overlap p10_x p10_y p10_w p10_h p27_x p27_y p27_w p27_h))) 	;p10 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p10_x p10_y p10_w p10_h))) 	;p28 with p10
(assert (not (overlap p10_x p10_y p10_w p10_h p28_x p28_y p28_w p28_h))) 	;p10 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p10_x p10_y p10_w p10_h))) 	;p29 with p10
(assert (not (overlap p10_x p10_y p10_w p10_h p29_x p29_y p29_w p29_h))) 	;p10 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p11_x p11_y p11_w p11_h))) 	;p25 with p11
(assert (not (overlap p11_x p11_y p11_w p11_h p25_x p25_y p25_w p25_h))) 	;p11 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p11_x p11_y p11_w p11_h))) 	;p26 with p11
(assert (not (overlap p11_x p11_y p11_w p11_h p26_x p26_y p26_w p26_h))) 	;p11 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p11_x p11_y p11_w p11_h))) 	;p27 with p11
(assert (not (overlap p11_x p11_y p11_w p11_h p27_x p27_y p27_w p27_h))) 	;p11 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p11_x p11_y p11_w p11_h))) 	;p28 with p11
(assert (not (overlap p11_x p11_y p11_w p11_h p28_x p28_y p28_w p28_h))) 	;p11 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p11_x p11_y p11_w p11_h))) 	;p29 with p11
(assert (not (overlap p11_x p11_y p11_w p11_h p29_x p29_y p29_w p29_h))) 	;p11 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p12_x p12_y p12_w p12_h))) 	;p25 with p12
(assert (not (overlap p12_x p12_y p12_w p12_h p25_x p25_y p25_w p25_h))) 	;p12 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p12_x p12_y p12_w p12_h))) 	;p26 with p12
(assert (not (overlap p12_x p12_y p12_w p12_h p26_x p26_y p26_w p26_h))) 	;p12 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p12_x p12_y p12_w p12_h))) 	;p27 with p12
(assert (not (overlap p12_x p12_y p12_w p12_h p27_x p27_y p27_w p27_h))) 	;p12 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p12_x p12_y p12_w p12_h))) 	;p28 with p12
(assert (not (overlap p12_x p12_y p12_w p12_h p28_x p28_y p28_w p28_h))) 	;p12 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p12_x p12_y p12_w p12_h))) 	;p29 with p12
(assert (not (overlap p12_x p12_y p12_w p12_h p29_x p29_y p29_w p29_h))) 	;p12 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p13_x p13_y p13_w p13_h))) 	;p25 with p13
(assert (not (overlap p13_x p13_y p13_w p13_h p25_x p25_y p25_w p25_h))) 	;p13 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p13_x p13_y p13_w p13_h))) 	;p26 with p13
(assert (not (overlap p13_x p13_y p13_w p13_h p26_x p26_y p26_w p26_h))) 	;p13 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p13_x p13_y p13_w p13_h))) 	;p27 with p13
(assert (not (overlap p13_x p13_y p13_w p13_h p27_x p27_y p27_w p27_h))) 	;p13 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p13_x p13_y p13_w p13_h))) 	;p28 with p13
(assert (not (overlap p13_x p13_y p13_w p13_h p28_x p28_y p28_w p28_h))) 	;p13 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p13_x p13_y p13_w p13_h))) 	;p29 with p13
(assert (not (overlap p13_x p13_y p13_w p13_h p29_x p29_y p29_w p29_h))) 	;p13 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p14_x p14_y p14_w p14_h))) 	;p25 with p14
(assert (not (overlap p14_x p14_y p14_w p14_h p25_x p25_y p25_w p25_h))) 	;p14 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p14_x p14_y p14_w p14_h))) 	;p26 with p14
(assert (not (overlap p14_x p14_y p14_w p14_h p26_x p26_y p26_w p26_h))) 	;p14 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p14_x p14_y p14_w p14_h))) 	;p27 with p14
(assert (not (overlap p14_x p14_y p14_w p14_h p27_x p27_y p27_w p27_h))) 	;p14 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p14_x p14_y p14_w p14_h))) 	;p28 with p14
(assert (not (overlap p14_x p14_y p14_w p14_h p28_x p28_y p28_w p28_h))) 	;p14 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p14_x p14_y p14_w p14_h))) 	;p29 with p14
(assert (not (overlap p14_x p14_y p14_w p14_h p29_x p29_y p29_w p29_h))) 	;p14 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p15_x p15_y p15_w p15_h))) 	;p25 with p15
(assert (not (overlap p15_x p15_y p15_w p15_h p25_x p25_y p25_w p25_h))) 	;p15 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p15_x p15_y p15_w p15_h))) 	;p26 with p15
(assert (not (overlap p15_x p15_y p15_w p15_h p26_x p26_y p26_w p26_h))) 	;p15 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p15_x p15_y p15_w p15_h))) 	;p27 with p15
(assert (not (overlap p15_x p15_y p15_w p15_h p27_x p27_y p27_w p27_h))) 	;p15 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p15_x p15_y p15_w p15_h))) 	;p28 with p15
(assert (not (overlap p15_x p15_y p15_w p15_h p28_x p28_y p28_w p28_h))) 	;p15 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p15_x p15_y p15_w p15_h))) 	;p29 with p15
(assert (not (overlap p15_x p15_y p15_w p15_h p29_x p29_y p29_w p29_h))) 	;p15 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p16_x p16_y p16_w p16_h))) 	;p25 with p16
(assert (not (overlap p16_x p16_y p16_w p16_h p25_x p25_y p25_w p25_h))) 	;p16 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p16_x p16_y p16_w p16_h))) 	;p26 with p16
(assert (not (overlap p16_x p16_y p16_w p16_h p26_x p26_y p26_w p26_h))) 	;p16 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p16_x p16_y p16_w p16_h))) 	;p27 with p16
(assert (not (overlap p16_x p16_y p16_w p16_h p27_x p27_y p27_w p27_h))) 	;p16 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p16_x p16_y p16_w p16_h))) 	;p28 with p16
(assert (not (overlap p16_x p16_y p16_w p16_h p28_x p28_y p28_w p28_h))) 	;p16 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p16_x p16_y p16_w p16_h))) 	;p29 with p16
(assert (not (overlap p16_x p16_y p16_w p16_h p29_x p29_y p29_w p29_h))) 	;p16 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p17_x p17_y p17_w p17_h))) 	;p25 with p17
(assert (not (overlap p17_x p17_y p17_w p17_h p25_x p25_y p25_w p25_h))) 	;p17 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p17_x p17_y p17_w p17_h))) 	;p26 with p17
(assert (not (overlap p17_x p17_y p17_w p17_h p26_x p26_y p26_w p26_h))) 	;p17 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p17_x p17_y p17_w p17_h))) 	;p27 with p17
(assert (not (overlap p17_x p17_y p17_w p17_h p27_x p27_y p27_w p27_h))) 	;p17 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p17_x p17_y p17_w p17_h))) 	;p28 with p17
(assert (not (overlap p17_x p17_y p17_w p17_h p28_x p28_y p28_w p28_h))) 	;p17 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p17_x p17_y p17_w p17_h))) 	;p29 with p17
(assert (not (overlap p17_x p17_y p17_w p17_h p29_x p29_y p29_w p29_h))) 	;p17 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p18_x p18_y p18_w p18_h))) 	;p25 with p18
(assert (not (overlap p18_x p18_y p18_w p18_h p25_x p25_y p25_w p25_h))) 	;p18 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p18_x p18_y p18_w p18_h))) 	;p26 with p18
(assert (not (overlap p18_x p18_y p18_w p18_h p26_x p26_y p26_w p26_h))) 	;p18 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p18_x p18_y p18_w p18_h))) 	;p27 with p18
(assert (not (overlap p18_x p18_y p18_w p18_h p27_x p27_y p27_w p27_h))) 	;p18 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p18_x p18_y p18_w p18_h))) 	;p28 with p18
(assert (not (overlap p18_x p18_y p18_w p18_h p28_x p28_y p28_w p28_h))) 	;p18 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p18_x p18_y p18_w p18_h))) 	;p29 with p18
(assert (not (overlap p18_x p18_y p18_w p18_h p29_x p29_y p29_w p29_h))) 	;p18 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p19_x p19_y p19_w p19_h))) 	;p25 with p19
(assert (not (overlap p19_x p19_y p19_w p19_h p25_x p25_y p25_w p25_h))) 	;p19 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p19_x p19_y p19_w p19_h))) 	;p26 with p19
(assert (not (overlap p19_x p19_y p19_w p19_h p26_x p26_y p26_w p26_h))) 	;p19 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p19_x p19_y p19_w p19_h))) 	;p27 with p19
(assert (not (overlap p19_x p19_y p19_w p19_h p27_x p27_y p27_w p27_h))) 	;p19 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p19_x p19_y p19_w p19_h))) 	;p28 with p19
(assert (not (overlap p19_x p19_y p19_w p19_h p28_x p28_y p28_w p28_h))) 	;p19 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p19_x p19_y p19_w p19_h))) 	;p29 with p19
(assert (not (overlap p19_x p19_y p19_w p19_h p29_x p29_y p29_w p29_h))) 	;p19 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p20_x p20_y p20_w p20_h))) 	;p25 with p20
(assert (not (overlap p20_x p20_y p20_w p20_h p25_x p25_y p25_w p25_h))) 	;p20 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p20_x p20_y p20_w p20_h))) 	;p26 with p20
(assert (not (overlap p20_x p20_y p20_w p20_h p26_x p26_y p26_w p26_h))) 	;p20 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p20_x p20_y p20_w p20_h))) 	;p27 with p20
(assert (not (overlap p20_x p20_y p20_w p20_h p27_x p27_y p27_w p27_h))) 	;p20 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p20_x p20_y p20_w p20_h))) 	;p28 with p20
(assert (not (overlap p20_x p20_y p20_w p20_h p28_x p28_y p28_w p28_h))) 	;p20 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p20_x p20_y p20_w p20_h))) 	;p29 with p20
(assert (not (overlap p20_x p20_y p20_w p20_h p29_x p29_y p29_w p29_h))) 	;p20 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p21_x p21_y p21_w p21_h))) 	;p25 with p21
(assert (not (overlap p21_x p21_y p21_w p21_h p25_x p25_y p25_w p25_h))) 	;p21 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p21_x p21_y p21_w p21_h))) 	;p26 with p21
(assert (not (overlap p21_x p21_y p21_w p21_h p26_x p26_y p26_w p26_h))) 	;p21 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p21_x p21_y p21_w p21_h))) 	;p27 with p21
(assert (not (overlap p21_x p21_y p21_w p21_h p27_x p27_y p27_w p27_h))) 	;p21 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p21_x p21_y p21_w p21_h))) 	;p28 with p21
(assert (not (overlap p21_x p21_y p21_w p21_h p28_x p28_y p28_w p28_h))) 	;p21 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p21_x p21_y p21_w p21_h))) 	;p29 with p21
(assert (not (overlap p21_x p21_y p21_w p21_h p29_x p29_y p29_w p29_h))) 	;p21 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p22_x p22_y p22_w p22_h))) 	;p25 with p22
(assert (not (overlap p22_x p22_y p22_w p22_h p25_x p25_y p25_w p25_h))) 	;p22 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p22_x p22_y p22_w p22_h))) 	;p26 with p22
(assert (not (overlap p22_x p22_y p22_w p22_h p26_x p26_y p26_w p26_h))) 	;p22 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p22_x p22_y p22_w p22_h))) 	;p27 with p22
(assert (not (overlap p22_x p22_y p22_w p22_h p27_x p27_y p27_w p27_h))) 	;p22 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p22_x p22_y p22_w p22_h))) 	;p28 with p22
(assert (not (overlap p22_x p22_y p22_w p22_h p28_x p28_y p28_w p28_h))) 	;p22 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p22_x p22_y p22_w p22_h))) 	;p29 with p22
(assert (not (overlap p22_x p22_y p22_w p22_h p29_x p29_y p29_w p29_h))) 	;p22 with p29
...
(assert (not (overlap p25_x p25_y p25_w p25_h p23_x p23_y p23_w p23_h))) 	;p25 with p23
(assert (not (overlap p23_x p23_y p23_w p23_h p25_x p25_y p25_w p25_h))) 	;p23 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p23_x p23_y p23_w p23_h))) 	;p26 with p23
(assert (not (overlap p23_x p23_y p23_w p23_h p26_x p26_y p26_w p26_h))) 	;p23 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p23_x p23_y p23_w p23_h))) 	;p27 with p23
(assert (not (overlap p23_x p23_y p23_w p23_h p27_x p27_y p27_w p27_h))) 	;p23 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p23_x p23_y p23_w p23_h))) 	;p28 with p23
(assert (not (overlap p23_x p23_y p23_w p23_h p28_x p28_y p28_w p28_h))) 	;p23 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p23_x p23_y p23_w p23_h))) 	;p29 with p23
(assert (not (overlap p23_x p23_y p23_w p23_h p29_x p29_y p29_w p29_h))) 	;p23 with p29

(assert (not (overlap p25_x p25_y p25_w p25_h p24_x p24_y p24_w p24_h))) 	;p25 with p24
(assert (not (overlap p24_x p24_y p24_w p24_h p25_x p25_y p25_w p25_h))) 	;p24 with p25

(assert (not (overlap p26_x p26_y p26_w p26_h p24_x p24_y p24_w p24_h))) 	;p26 with p24
(assert (not (overlap p24_x p24_y p24_w p24_h p26_x p26_y p26_w p26_h))) 	;p24 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p24_x p24_y p24_w p24_h))) 	;p27 with p24
(assert (not (overlap p24_x p24_y p24_w p24_h p27_x p27_y p27_w p27_h))) 	;p24 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p24_x p24_y p24_w p24_h))) 	;p28 with p24
(assert (not (overlap p24_x p24_y p24_w p24_h p28_x p28_y p28_w p28_h))) 	;p24 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p24_x p24_y p24_w p24_h))) 	;p29 with p24
(assert (not (overlap p24_x p24_y p24_w p24_h p29_x p29_y p29_w p29_h))) 	;p24 with p29

(assert (not (overlap p26_x p26_y p26_w p26_h p25_x p25_y p25_w p25_h))) 	;p26 with p25
(assert (not (overlap p25_x p25_y p25_w p25_h p26_x p26_y p26_w p26_h))) 	;p25 with p26

(assert (not (overlap p27_x p27_y p27_w p27_h p25_x p25_y p25_w p25_h))) 	;p27 with p25
(assert (not (overlap p25_x p25_y p25_w p25_h p27_x p27_y p27_w p27_h))) 	;p25 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p25_x p25_y p25_w p25_h))) 	;p28 with p25
(assert (not (overlap p25_x p25_y p25_w p25_h p28_x p28_y p28_w p28_h))) 	;p25 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p25_x p25_y p25_w p25_h))) 	;p29 with p25
(assert (not (overlap p25_x p25_y p25_w p25_h p29_x p29_y p29_w p29_h))) 	;p25 with p29

(assert (not (overlap p27_x p27_y p27_w p27_h p26_x p26_y p26_w p26_h))) 	;p27 with p26
(assert (not (overlap p26_x p26_y p26_w p26_h p27_x p27_y p27_w p27_h))) 	;p26 with p27

(assert (not (overlap p28_x p28_y p28_w p28_h p26_x p26_y p26_w p26_h))) 	;p28 with p26
(assert (not (overlap p26_x p26_y p26_w p26_h p28_x p28_y p28_w p28_h))) 	;p26 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p26_x p26_y p26_w p26_h))) 	;p29 with p26
(assert (not (overlap p26_x p26_y p26_w p26_h p29_x p29_y p29_w p29_h))) 	;p26 with p29

(assert (not (overlap p28_x p28_y p28_w p28_h p27_x p27_y p27_w p27_h))) 	;p28 with p27
(assert (not (overlap p27_x p27_y p27_w p27_h p28_x p28_y p28_w p28_h))) 	;p27 with p28

(assert (not (overlap p29_x p29_y p29_w p29_h p27_x p27_y p27_w p27_h))) 	;p29 with p27
(assert (not (overlap p27_x p27_y p27_w p27_h p29_x p29_y p29_w p29_h))) 	;p27 with p29

(assert (not (overlap p29_x p29_y p29_w p29_h p28_x p28_y p28_w p28_h))) 	;p29 with p28
(assert (not (overlap p28_x p28_y p28_w p28_h p29_x p29_y p29_w p29_h))) 	;p28 with p29
