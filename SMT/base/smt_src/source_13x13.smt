...
(define-fun width () Int 13)
(define-fun height () Int 13)
...
(define-fun p7_w () Int 4)
(define-fun p7_h () Int 3)
(define-fun p8_w () Int 4)
(define-fun p8_h () Int 4)
(define-fun p9_w () Int 7)
(define-fun p9_h () Int 6)
