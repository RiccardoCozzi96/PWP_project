...
(define-fun width () Int 18)
(define-fun height () Int 18)
...
(define-fun p7_h () Int 10)
(define-fun p8_w () Int 3)
(define-fun p8_h () Int 11)
(define-fun p9_w () Int 4)
(define-fun p9_h () Int 3)
(define-fun p10_w () Int 4)
(define-fun p10_h () Int 4)
(define-fun p11_w () Int 4)
(define-fun p11_h () Int 5)
(define-fun p12_w () Int 4)
(define-fun p12_h () Int 6)
(define-fun p13_w () Int 5)
