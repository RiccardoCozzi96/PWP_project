...
(define-fun max_width () Int 38)
(define-fun max_height () Int 38)
...
(define-fun p12_h () Int 5)
(define-fun p13_w () Int 4)
(define-fun p13_h () Int 6)
(define-fun p14_w () Int 4)
(define-fun p14_h () Int 8)
(define-fun p15_w () Int 4)
(define-fun p15_h () Int 11)
(define-fun p16_w () Int 4)
(define-fun p16_h () Int 12)
(define-fun p17_w () Int 4)
(define-fun p17_h () Int 15)
(define-fun p18_w () Int 4)
(define-fun p18_h () Int 16)
(define-fun p19_w () Int 24)
(define-fun p19_h () Int 38)
