...
(define-fun width () Int 29)
(define-fun height () Int 29)
...
(define-fun p11_h () Int 18)
(define-fun p12_w () Int 3)
(define-fun p12_h () Int 20)
(define-fun p13_w () Int 4)
(define-fun p13_h () Int 3)
(define-fun p14_w () Int 4)
(define-fun p14_h () Int 4)
(define-fun p15_w () Int 4)
(define-fun p15_h () Int 5)
(define-fun p16_w () Int 4)
(define-fun p16_h () Int 6)
(define-fun p17_w () Int 4)
(define-fun p17_h () Int 7)
(define-fun p18_w () Int 4)
(define-fun p18_h () Int 9)
(define-fun p19_w () Int 4)
(define-fun p19_h () Int 15)
(define-fun p20_w () Int 4)
(define-fun p20_h () Int 18)
(define-fun p21_w () Int 4)
(define-fun p21_h () Int 20)
(define-fun p22_w () Int 5)
(define-fun p22_h () Int 4)
(define-fun p23_w () Int 5)
(define-fun p23_h () Int 8)
(define-fun p24_w () Int 5)
(define-fun p24_h () Int 17)
